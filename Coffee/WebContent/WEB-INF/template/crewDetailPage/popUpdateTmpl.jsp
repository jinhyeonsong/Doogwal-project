...
<script type="text/template" id="popUpdateTmpl">
	<div class="pop_update"><!-- popWrite start-->
            ...
            <form id="writeForm" method="post" action="/updatePost.do">
                ...
                <fieldset>
                    ...
                    <input type="hidden" name="postNo" value="<@=updateSelectPostNo@>"/>
                    ...
                    <div id="standalone-container">
                        ...
                        <div id="editorContainer">
							<div class="ql-editor update_contents" data-gramm="false" contenteditable="true"><@=c.contents @></div>
						</div>
                        <div class="file_box">
